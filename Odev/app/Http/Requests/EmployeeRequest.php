    ...
    class EmployeeRequest extends FormRequest
    {
        ...
        public function rules(): array
        {
            return [
                ...
                'kimlik_no' => 'required|string|max:255|unique:employees|regex:/^[0-9]{11}$/',
        ...
        public function messages(): array
        {
            return [
                ...
                'kimlik_no.unique' => 'Bu kimlik numarası zaten kullanılmaktadır.',
                ...
                'phone.max' => 'Telefon numarası maksimum 255 karakter içermelidir.',
